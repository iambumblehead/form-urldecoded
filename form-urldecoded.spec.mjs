...
test("should decode a complex query string", t => {
  t.deepEqual(formurldecoded(
    'www.myurl.com?'
...
test("should not return a hash value by default", t => {
  t.is(formurldecoded(
    'www.myurl.com?param1=1&param2=two#hash').hash, undefined);
});

test("should return complex object", t => {
  t.is(formurldecoded(
...
test("should return decoded data", t => {
  t.deepEqual(formurldecoded('propStr1=str1&propStr2=str2'), {
    propStr1 : 'str1',
    propStr2 : 'str2'
  });
});
...
test("should not break when null argument is given", t => {
  t.deepEqual(formurldecoded(null), {});
  t.deepEqual(formurldecoded(undefined), {});
});
...
test("should return decoded empty array", t => {
  t.deepEqual(formurldecoded('emptyArr%5B%5D'), {
    emptyArr : []
  });
});
...
test("should return array with index", t => t.deepEqual(
  formurldecoded('key%5B0%5D=val1'), {
    key : ['val1']
  }));

test("should return array without index", t => t.deepEqual(
  formurldecoded('key%5B%5D=val1'), {
    key : ['val1']
  }));

test("should return decoded urls with unicode characters", t => t.deepEqual(
